                    ...
                    <?php if (isset($couriers[$key]->name)): ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url('couriers/delete/' . $couriers[$key]->courier_id) ?>"  onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                            </ul>
                        </div>
                    <?php endif; ?>
                </td>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url('couriers/delete/' . $couriers[$key + $third_part]->courier_id) ?>" onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
                </td>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url('couriers/delete/' . $couriers[$key + 2 * $third_part]->courier_id) ?>" onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
                </td>
