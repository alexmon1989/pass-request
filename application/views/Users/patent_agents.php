...
<div class="span12">
    ...
    <h4>Натисніть на особу для редагування її даних.</h4>
                    ...
                    <?php if (isset($patent_agents[$key]->name)): ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url('patent_agents/delete/' . $patent_agents[$key]->patent_agent_id) ?>"  onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                            </ul>
                        </div>
                    <?php endif; ?>
                </td>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url('patent_agents/delete/' . $patent_agents[$key + $third_part]->patent_agent_id) ?>" onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
                </td>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url('patent_agents/delete/' . $patent_agents[$key + 2 * $third_part]->patent_agent_id) ?>" onclick="return confirm('Ви дійсно бажаєте видалити цю особу?')"><i class="icon-remove"></i> Видалити особу</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
                </td>
