...
<div id="maindiv" class="span12">
    <div style="width: 100%">
        <div style="float: left; width: 49%;">
            ...
            <br />
            <?php echo form_open('admin/patent_agents/add_request_to_db/' . $patent_agent->patent_agent_id, 'id="add_form" class="form-horizontal"'); ?>
                <fieldset> 
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <select id="applicant_name" name="applicant_name" style="width: 280px">
                                ...
                                <option value="<?php echo $applicant->applicant_id; ?>" <?php echo set_select('applicant_name', $applicant->applicant_id, (int) $applicant->applicant_id === $patent_agent->applicant_id) ?>><?php echo $applicant->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <strong style="font-size: 18px"><?php echo $patent_agent->name; ?></strong>
                            <input type="hidden" id="patent_agent_id" name="patent_agent_id">
                        </div>
                    </div>     
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <select id="room_number" name="room_number" style="width: 280px">
                                ...
                                <option value="<?php echo $room->room_id; ?>" <?php echo set_select('room_number', $room->room_id, (int)$room->room_id === $patent_agent->room_id); ?>><?php echo $room->number; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="req-div2">
                            <select id="document_type" name="document_type" style="width: 280px">
                                ...
                                <?php foreach ($document_types as $document_type): ?>
                                    <option value="<?php echo $document_type->document_type_id; ?>"<?php echo set_select('document_type', $document_type->document_type_id, (int) $document_type->document_type_id === (int) $patent_agent->document['document_type_id']); ?>><?php echo $document_type->type; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div id="document_attrs" style="display: none">
                        <div class="control-group">
                            ...
                            <div class="req-div2">
                                <input type="text" id="document_series" name="document_series" class="input-xlarge" value="<?php echo set_value('document_series', $patent_agent->document['document_series']); ?>">                       
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="req-div1">Номер*</div> 
                            <div class="req-div2">
                                <input type="text" id="document_number" name="document_number" class="input-xlarge" value="<?php echo set_value('document_number', $patent_agent->document['document_number']); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
        ...
        <div style="float: right; width: 49%;">
            <div class="control-group">
                ...
                <?php if ($patent_agent->photo_id !== null): ?>
                    <img id="photo_img" src="<?php echo base_url('photos/get_image/' . $patent_agent->photo_id); ?>">
                <?php else: ?>
                    <img id="photo_img" src="<?php echo base_url('images/photo_missed.jpeg'); ?>">
                <?php endif; ?>
                <input type="hidden" id="photo_id" name="photo_id" value="<?php if ($patent_agent->photo_id === NULL) echo 0; else echo $patent_agent->photo_id; ?>">    
