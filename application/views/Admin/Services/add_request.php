...
<div id="maindiv" class="span12">
    <div style="width: 100%">
        <div style="float: left; width: 49%;">
            ...
            <br />
            <?php echo form_open('admin/service/add_request_to_db/' . $service_employee->service_employee_id, 'id="add_form" class="form-horizontal"'); ?>
                <fieldset> 
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <select id="applicant_name" name="applicant_name" style="width: 280px">
                                ...
                                <option value="<?php echo $applicant->applicant_id; ?>" <?php echo set_select('applicant_name', $applicant->applicant_id, (int) $applicant->applicant_id === $service_employee->applicant_id) ?>><?php echo $applicant->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <strong style="font-size: 18px"><?php echo $service_employee->name; ?></strong>
                        </div>
                    </div>     
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <select id="room_number" name="room_number" style="width: 280px">
                                ...
                                <option value="<?php echo $room->room_id; ?>" <?php echo set_select('room_number', $room->room_id, (int)$room->room_id === $service_employee->room_id); ?>><?php echo $room->number; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="req-div2">
                            <select id="document_type" name="document_type" style="width: 280px">
                                ...
                                <?php foreach ($document_types as $document_type): ?>
                                    <option value="<?php echo $document_type->document_type_id; ?>"<?php echo set_select('document_type', $document_type->document_type_id, (int) $document_type->document_type_id === (int) $service_employee->document['document_type_id']); ?>><?php echo $document_type->type; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div id="document_attrs" style="display: none">
                        <div class="control-group">
                            ...
                            <div class="req-div2">
                                <input type="text" id="document_series" name="document_series" class="input-xlarge" value="<?php echo set_value('document_series', $service_employee->document['document_series']); ?>">                       
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="req-div1">Номер*</div> 
                            <div class="req-div2">
                                <input type="text" id="document_number" name="document_number" class="input-xlarge" value="<?php echo set_value('document_number', $service_employee->document['document_number']); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="req-div2">
                            <select id="pass_number" name="pass_number" class="input-xlarge" style="width: 280px">
                                ...
                                <option value="<?php echo $pass['value']; ?>" <?php echo set_select('pass_number', $pass['value'], $pass['value'] === $service_employee->pass_id);?>><?php echo $pass['text']; ?></option>
                                <?php endforeach; ?>
                         </select>
                        </div>
                    </div> 
        ...
        <div style="float: right; width: 49%;">
            <div class="control-group">
                ...
                <?php if ($service_employee->photo_id !== null): ?>
                    <img id="photo_img" src="<?php echo base_url('photos/get_image/' . $service_employee->photo_id); ?>">
                <?php else: ?>
                    <img id="photo_img" src="<?php echo base_url('images/photo_missed.jpeg'); ?>">
                <?php endif; ?>
                <input type="hidden" id="photo_id" name="photo_id" value="<?php if ($service_employee->photo_id === NULL) echo 0; else echo $service_employee->photo_id; ?>">    
