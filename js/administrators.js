function SendAddData () {
        ...
        $.post("admin/administrators/add", str, function(data) {
...
function SendEditData () {
        ...
        $.post("admin/administrators/edit", str, function(data) {
...
function FillEditForm(id){
        ...
        $.post("admin/administrators/get_login_by_id/" + id, function(data) {
            $("#login").text(data);
            });
