function SendAddData () {
        ...
        $.post("admin/applicants/add", str, function(data) {
...
function SendEditData () {
        ...
        $.post("admin/applicants/edit", str, function(data) {
...
function FillEditForm(id){
        ...
        $.post("admin/applicants/get_login_by_id/" + id, function(data) {
            $("#login").text(data);
            });
        $.post("admin/applicants/is_chancelerry/" + id, function(data) {
            if (data == "yes")
